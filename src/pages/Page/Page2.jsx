...
const Page2 = () => {
  ...
  return (
    <Wrap>
      ...
      <div class="hidden ml-8 text-lg text-white md:flex">Tail-kit</div>
      ...
      <div class="flex flex-row-reverse ml-4 mr-4 text-white md:hidden">
        <button>
          <svg
            width="20"
            height="20"
      ...
      <div class="flex items-center hidden mr-8 md:flex">
        <a
          href="https://github.com/Charlie85270/tail-kit"
          class="p-1 text-white rounded-full focus:outline-none hover:text-gray-200 focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
        >
        ...
        <a href="#" class="">
          <svg
            ...
            height="1792"
            fill="currentColor"
            class="w-8 h-8 mr-2 text-white hover:text-gray-100"
